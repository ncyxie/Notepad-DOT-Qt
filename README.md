*Last time information was updated: 11/08/2021*
...
2. Enter this command: ``winget install ncyxie.Notepad-DOT-Qt`` and wait for **winget** tool to finish setup process (it's automatic);
